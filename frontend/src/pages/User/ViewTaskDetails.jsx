              ...
              <div className="mt-2">
                ...
                {task?.todoChecklist?.map((todo, index) => (
                  <TodoCheckList
                    ...
                    onCheckChange={() => updateTodoCheckList(index)}
                  />
                ))}
              </div>
...
const TodoCheckList = ({ text, isChecked, onCheckChange }) => {
  return (
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div
      className="flex justify-between bg-gray-40 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer"
      onClick={onClick}
    >
